 ...
 * </p>
 */
public class UIDataSourceIterator extends UIDataIterator implements FacesComponent, ThemeControl {
    
    public static final String COMPONENT_TYPE = "biz.webgate.dominoext.poi.component.containers.DataSourceIterator"; //$NON-NLS-1$
